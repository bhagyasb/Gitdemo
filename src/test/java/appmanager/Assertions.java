...
import static appmanager.ExtentCucumberFormatter.testStepPassed;


public class Assertions extends HelperBase{

    private final boolean isTestFailure = false;
     ...
     * @param expected
     */
    public void assertEquals(java.lang.String actual, String expected){
